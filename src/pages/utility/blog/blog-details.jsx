          ...
          <div className="grid grid-cols-1 gap-5">
            <Card>
              ...
              <div className="mt-6">
                ...
                <ul className="lg:flex items-center lg:space-x-3 lg:rtl:space-x-reverse mt-4 border-b border-slate-100 dark:border-slate-700 pb-6">
                  ...
                  {tags.map((item, i) => (
                    <li key={i}>
                      <Link
                        to="#"
                        className="text-xs font-normal text-slate-600 dark:text-slate-300 bg-slate-100 dark:bg-slate-600 py-1 px-3 rounded-full hover:bg-scooton-900 hover:text-white transition duration-150"
                      >
                ...
                <div className="post-comments bg-slate-100 dark:bg-scooton-900 p-6 rounded-md mt-6">

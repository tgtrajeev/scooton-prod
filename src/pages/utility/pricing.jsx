        ...
        <Card>
          <div className="flex justify-between mb-6">
            ...
            <label className="inline-flex text-sm cursor-pointer">
              ...
              <span
                className={` ${
                  check
                    ? "bg-scooton-900 dark:bg-scooton-900 text-white"
                    : "dark:text-slate-300"
                } 
          ...
          `}
              ...
              >
                ...
                {item.ribon && (
                  <div className="text-sm font-medium bg-scooton-900 dark:bg-scooton-900 text-white py-2 text-center absolute ltr:-right-[43px] rtl:-left-[43px] top-6 px-10 transform ltr:rotate-[45deg] rtl:-rotate-45">
                    {item.ribon}
                  </div>
                )}

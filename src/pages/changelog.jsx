                ...
                <Disclosure>
                  {({ open }) => (
                    <>
                      ...
                      <Disclosure.Panel>
                        <div className="text-sm text-slate-600 font-normal bg-white dark:bg-scooton-900 dark:text-slate-300 rounded-b-md dark:border dark:border-slate-700 dark:border-t-0 border border-slate-100 border-t-0">
